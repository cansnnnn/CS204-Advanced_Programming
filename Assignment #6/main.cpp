...
#include <fstream>
#include <sstream>
#include "cansinnarsahin_Narsahin_Cansin_hw6_board.h"//change this with your board header file name
#include "cansinnarsahin_Narsahin_Cansin_hw6_player.h" //change this with your player header file name
